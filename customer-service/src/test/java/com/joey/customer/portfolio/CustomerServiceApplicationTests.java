package com.joey.customer.portfolio;
...
class CustomerServiceApplicationTests {
    ...
    public void buyAndSell() {
        ...
        getCustomer(2, HttpStatus.OK)
                ...
                .jsonPath("$.holding.length()").isEqualTo(1)
                .jsonPath("$.holding[0].ticker").isEqualTo("GOOGLE")
                .jsonPath("$.holding[0].quantity").isEqualTo(15);
        ...
        getCustomer(2, HttpStatus.OK)
                ...
                .jsonPath("$.holding.length()").isEqualTo(1)
                .jsonPath("$.holding[0].ticker").isEqualTo("GOOGLE")
                .jsonPath("$.holding[0].quantity").isEqualTo(0);
    }
