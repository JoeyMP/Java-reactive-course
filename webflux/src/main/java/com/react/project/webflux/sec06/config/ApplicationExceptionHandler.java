...
public class ApplicationExceptionHandler {
    ...
    public Mono<ServerResponse> handlerException(CustomerNotFoundException ex, ServerRequest request) {
    ...
    public Mono<ServerResponse> handlerException(InvalidInputException ex, ServerRequest request) {
